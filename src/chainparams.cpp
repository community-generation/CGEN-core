...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
      (0, uint256("0x00000a82c900bc5c9e301d4463d522b338fa43062479611af47dd7d67d530f3e"))
      (46, uint256("0000019a5b42a648ec19e4ecd914399e4288f4a28705bb33ab8f2aeb72e0cc3d"))
      (120, uint256("0000001d4007abb874c6b8f8da57eb0890897536c4ab0153a645fe93d5ff9bda"))
      (526956, uint256("1c1ffe866c8363e6cf2ce7c1036bd0b2c51693af612cae277ca9c8148c7d5d18"))
    ;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1583365302, // * UNIX timestamp of last checkpoint block
    1161104,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 29801;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // CGEN starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CGEN: 1 day
        ...
        const char* pszTimestamp = "01/30/2019 - Big day for new start! @SmartyInsider";
        ...
        vSeeds.push_back(CDNSSeedData("78.47.143.6", "78.47.143.6"));
        vSeeds.push_back(CDNSSeedData("49.12.0.7", "49.12.0.7"));
        vSeeds.push_back(CDNSSeedData("95.216.222.108", "95.216.222.108"));
		vSeeds.push_back(CDNSSeedData("78.46.151.195", "78.46.151.195"));
        ...
        strSporkKey = "04c0d2e0654f2f084c981246d1aa741ee928cbfb9e19c5e3bcf0f59c8c7e1d81a2a068e5f7bdeacb6e1a5c7a650f9939243d2d2016f48cbec723b71cf15213674c";
...
public:
    CTestNetParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000f608a7850c5d3f5f4b017624e31dd776457d7e980c966d65055a13b7d77"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("test1.cgencore.io", "test1.cgencore.io"));
        vSeeds.push_back(CDNSSeedData("test2.cgencore.io", "test2.cgencore.io"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet cgencore addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet cgencore script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cgencore BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cgencore BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cgencore BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CGEN: 1 day
        nTargetSpacing = 1 * 60;        // CGEN: 1 minutes
        ...
        assert(hashGenesisBlock == uint256("0x6dde93abec1ff5c7046fabd32519a4441fcc392179d06423d240675d4a68af6d"));
