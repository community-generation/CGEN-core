                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(1020, 550), this);

    QString windowTitle = tr("CGEN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CGEN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cgencore: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CGEN Core"), this);
    aboutAction->setStatusTip(tr("Show information about CGEN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CGEN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CGEN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CGEN addresses"));
    ...
    openAction->setStatusTip(tr("Open a CGEN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CGEN Core help message to get a list with possible CGEN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CGEN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CGEN network", "", count));
}
...
{
    QString strTitle = tr("CGEN Core"); // default title
